...
classdef OandaAPI
 ...
 % %% token for live account
 
% b26dbcb9ad2f2d2e631a643ab48500a6-f0058b52d563951935b16725424a51db
% account no.
% 942041
...
%        account = '001-004-391907-001';
       %account = '942041';    
     account= '7975484'; % live
...
%            token ='9dcfaa560886302ff4817957b337d8df-2521e79a49f5420fb12011f5a891f88f'%'12345678900987654321-abc34135acde13f13530';
%            environment = 'practice';
%s_apiServer = 'https://api-fxtrade.oanda.com/';           

           s_apiServer = 'https://api-fxpractice.oanda.com/';%url to OANDA api sandbox
%            api = OandaAPI(token,environment,account)
           %username;
           %password;
           connected = false;
           streaming ;
...
%               
              if(nargin ==3)
               ...
               elseif(nargin ==0)
%                   api.token   = 'e4f426366939cde4918847bf77f3b5c6-f11d0573a344edd0a806a6462e80da5c';
                   api.token   = 'b26dbcb9ad2f2d2e631a643ab48500a6-f0058b52d563951935b16725424a51db';%'12345678900987654321-abc34135acde13f13530'
                      % api.token   = '9dcfaa560886302ff4817957b337d8df-2521e79a49f5420fb12011f5a891f88f';%'12345678900987654321-abc34135acde13f13530';%demo token
                       account='0';
                       print('DEMO');
                       clc
               elseif(nargin ==1)
...
% ?M? - 1 Month
           ...
           % [id,order1] = api.CreateOrder('EUR_USD' , 5, 'buy') *** this
           % works
