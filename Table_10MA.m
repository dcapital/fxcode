...
outputMatrix_10MA=zeros(size((New_datax),1)-1,76);
disp('calculating 10 period moving averages.....')
...
outputMatrix_MA10(:,i)=temp;
end

col_header_3 =New_datax(1,:);
Table_10MAcal = num2cell(outputMatrix_MA10);
T_10MA =[col_header_3 ;Table_10MAcal(end,1:end)]';
